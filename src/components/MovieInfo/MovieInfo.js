...
const MovieInfo = () => {
    ...
    return (
        <div>
            ...
            <h1 className={css.container2}>
                <Badge color="secondary">"Інформація про фільм"</Badge>
            </h1>
            <div className={css.container}>
                <img className={css.carta} src={`https://image.tmdb.org/t/p/original/${state.backdrop_path}`} alt={state.original_title}/>
